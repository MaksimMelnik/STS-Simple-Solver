...
for var=1:12
%testcases     
%var: %1 - 2-N-03 T=3580 K, P=0.393 atm;  2 - 2-N-15 T=6080 K, P=0.097 atm;
%3 - 2-N-17 T=6970 K, P=0.054 atm; 4 - 04-N-01 T=1880 K, P=0.646 atm;
%5 - 04-N-08 T=3570 K, P=0.870 atm; 6 - 04-N-11 T=5190 K, P=0.239 atm;
%7 - 2-A-04 T=3730 K, P=0.405 atm; 8 - 2-A-11 T=6240 K, P=0.423;
%9 - 2-A-19 T=8210 K, P=0.114; 10 - 04-A-01 T=1920 K, P=0.781 atm;
%11 - 04-A-08 T=3490 K, P=0.838 atm; 12 - 04-A-16 T=6050 K, P=0.415 atm;
...
nexttile 
set(gca, 'FontName', 'Times New Roman');
loglog(data_main(i_vibr,2,var,2).time, data_main(i_vibr,2,var,2).ni_N2(:,1)/Na*1e3, 'b-', 'LineWidth',1.5);
hold on
loglog(data_main(i_vibr,3,var,2).time, data_main(i_vibr,3,var,2).ni_N2(:,1)/Na*1e3, 'b--', 'LineWidth',1.5);
loglog(data_main(i_vibr,4,var,2).time, data_main(i_vibr,4,var,2).ni_N2(:,1)/Na*1e3, 'b-.', 'LineWidth',1.5);
hold off
title("n^{\nu=0}_{N_2}");
xlim([0 tlim_n]);
legend("n^{\nu=0}_{N_2}, U=D/6k", "n^{\nu=0}_{N_2}, U=3T", "n^{\nu=0}_{N_2}, U=\infty", 'Location','best');
xlabel("t, \mus");
ylabel("n_i, mmol/m^3");

nexttile
set(gca, 'FontName', 'Times New Roman');
loglog(data_main(i_vibr,2,var,2).time, data_main(i_vibr,2,var,2).ni_N2(:,end)/Na*1e3, 'r-', 'LineWidth',1.5);
hold on
loglog(data_main(i_vibr,3,var,2).time, data_main(i_vibr,3,var,2).ni_N2(:,end)/Na*1e3, 'r--', 'LineWidth',1.5);
loglog(data_main(i_vibr,4,var,2).time, data_main(i_vibr,4,var,2).ni_N2(:,end)/Na*1e3, 'r-.', 'LineWidth',1.5);
hold off
title("n^{\nu=46}_{N_2}");
xlim([0 tlim_n]);
legend( "n^{\nu=46}_{N_2}, U=D/6k", "n^{\nu=46}_{N_2}, U=3T", "n^{\nu=46}_{N_2}, U=\infty", 'Location','best');
xlabel("t, \mus");
ylabel("n_i, mmol/m^3");

nexttile
set(gca, 'FontName', 'Times New Roman');
loglog(data_main(i_vibr,2,var,2).time, data_main(i_vibr,2,var,2).ni_O2(:,1)/Na*1e3, 'b-', 'LineWidth',1.5);
hold on
loglog(data_main(i_vibr,3,var,2).time, data_main(i_vibr,3,var,2).ni_O2(:,1)/Na*1e3, 'b--', 'LineWidth',1.5);
loglog(data_main(i_vibr,4,var,2).time, data_main(i_vibr,4,var,2).ni_O2(:,1)/Na*1e3, 'b-.', 'LineWidth',1.5);
hold off
title("n^{\nu=0}_{O_2}");
xlim([0 tlim_n]);
legend("n^{\nu=0}_{O_2}, U=D/6k", "n^{\nu=0}_{O_2}, U=3T", "n^{\nu=0}_{O_2}, U=\infty", 'Location','best');
...
nexttile
set(gca, 'FontName', 'Times New Roman');
loglog(data_main(i_vibr,2,var,2).time, data_main(i_vibr,2,var,2).ni_O2(:,end)/Na*1e3, 'r-', 'LineWidth',1.5);
hold on
loglog(data_main(i_vibr,3,var,2).time, data_main(i_vibr,3,var,2).ni_O2(:,end)/Na*1e3, 'r--', 'LineWidth',1.5);
loglog(data_main(i_vibr,4,var,2).time, data_main(i_vibr,4,var,2).ni_O2(:,end)/Na*1e3, 'r-.', 'LineWidth',1.5);
hold off
title("n^{\nu=35}_{O_2}");
xlim([0 tlim_n]);
...
xlabel("t, \mus");
ylabel("n_i, mmol/m^3");
exportgraphics(t,"NON2Ar_FHO_case"+num2str(var)+".jpg");
