...
for i_scheme = 1 % [1 2] % chosing the kinetic scheme: 
   ...
   React_N2B_N2__N_N_N2   = Reactions("N2(B) + N2 -> N(4S) + N(4S) + N2");
   React_N2pX_O2X__O2pX_N2 = Reactions("N2+(X) + O2(X) -> O2+(X) + N2");
   React_N_O_N2__NOX_N2    = Reactions("NO(X) + N2 -> N(4S) + O + N2");
   React_N_O_O2__NOX_O2    = Reactions("NO(X) + O2 -> N(4S) + O + O2");
   ...
   switch i_scheme
       case 1   % actual kinetic scheme
        ...
        Exch = [ReactZel_1("Savelev2018") ...
                ...
                , React_N2B_N2__N2X_N2("Pintassilgo2009_Starik") ...
                , React_N2B_N2__N_N_N2("Pintassilgo2009_Starik") ...
                , React_N_O_N2__NOX_N2("Pintassilgo2009_Starik") ...
                , React_N_O_O2__NOX_O2("Pintassilgo2009_Starik") ...
                ];
       ...
       case 2   % Portuguese kinetic scheme
        ...
        Exch = [ReactZel_1("Guerra95"), ...
            ReactZel_1("Guerra95_reverse") ...
                ...
                , React_N2B_N2__N2X_N2("Pintassilgo2009") ...
                , React_N2B_N2__N_N_N2("Pintassilgo2009") ...
                , React_N_O_N2__NOX_N2("Pintassilgo2009") ...
                , React_N_O_O2__NOX_O2("Pintassilgo2009") ...
                ];
   ...
   ET_diff_c{1} = [Reactions("zero"), N2A_diff("Levron1978"), ...
       ...                                          N2(B)
                                                    Reactions("zero")];
   Rec_wall_target = 1; % recombination on the wall target state
   % Rec_wall_target = 17;  % 16th level
   Reacs_keys = {'VT',     ...
       'VV' ...
       , ... 
       'Exch' ...
...
%                         'NonNegative', 1:length(y0)); 
   ...
   %                      'NonNegative', 1:length(y0)); 
   options_s = odeset('RelTol', 1e-10, 'AbsTol', 1e-11, ...
                        'NonNegative', 1:length(y0)); 
