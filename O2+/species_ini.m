...
N_a=6.02214076e23;  % Avogadro constant
    ...
    % Oxygen atoms
O.mass=2.6567628316576e-26;
O.form_e = 4.098045681049634e-19;
O.num_elex_levels=1;
O.e_E=[0 3.140272800000000e-19];    % O(3P), O(1D)
...
O2.e_E=[0 1.5653e-19 2.6067e-19]; % electron excited levels energy 
