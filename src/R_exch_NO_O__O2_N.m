...
Kdr=zeros(sum(O2.num_vibr_levels), sum(NO.num_vibr_levels)); %матрица 36 на 47
s_e_O_N=9/4; % s_e_O/s_e_N
m_O=2.6567628316576e-26;    m_N=2.32587E-26;

i=1;
for j=1:O2.num_vibr_levels %для каждого колебательного уровня кислорода я 
    %заполняю эту матрицу согласно формуле
...
RExch1=n_O2.*kr*n_N - n_NO'.*n_O*kd; %тут по наитию написал формулу, 
%главное что на выходе получается матрица
