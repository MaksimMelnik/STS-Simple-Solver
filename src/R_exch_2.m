function [R_exch_data, Q] = ...
            R_exch_2(M1, M2, M3, M4, n_M1, n_M2, n_M3, n_M4, T, reaction)
...
dE_M1 = coll.ArrE - ...
    repmat((M1.ev_0(1) + M1.ev_i{1})'/V_K, 1, 1) + ...
    repmat((M3.ev_0(1))/V_K, M1.num_vibr_levels(1), 1);
else
    dE_M1 = coll.ArrE - ...
...
kb = kf .* Kfb;
if VDOP==0
RExch1 = sum(n_M3)' * n_M4 .* kb  -  n_M1 * n_M2 .* kf;
else
