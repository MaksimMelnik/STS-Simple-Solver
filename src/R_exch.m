function out = R_exch(M1, M2, M3, M4, n_M1, n_M2, n_M3, n_M4, T, coll, VDOP)
%Function for exchange reaction M1+M2->M3+M4
%M1 and M3 molecules, M2 and M4 - atoms 
%VDOP -  switcher of Vibrational deactivation of product. 1 - taking into
%account vibrational activation of product of reaction, 0 - without vibr. 
...
kb= kf .* Kfb;
RExch1=n_M3'.*kb*n_M4 - n_M1.*kf*n_M2;

%get matrix M1.num_vibr_levels by M3.num_vibr_levels, energy M1 in rows,
%M3 energy in columns.
out = RExch1;
end
end